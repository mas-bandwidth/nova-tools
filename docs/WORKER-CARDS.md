...
For a v2 card, link the matching reviewed pull request from [Card exemplars](EXEMPLARS.md) in
the task body as `Example to follow:`. The example demonstrates method and evidence; it does not
override the card's pinned source, PATHS, test, or DONE-WHEN.
