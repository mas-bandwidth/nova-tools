...
4. `TestTheToolKeepsNoMemory` — after fifty turns the state holds no file containing any message body of eight characters or more and its keys are exactly the documented set, `flood:<conversation>` among them; a written transcript turns it red.
