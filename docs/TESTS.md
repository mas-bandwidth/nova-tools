...
INBOX OPEN carrying=1 heard=0 large=false remedy=reply --re <id> or receipt --note <id>; close --before <cutoff> to bulk-close
...
INBOX OPEN carrying=0 heard=0 large=false remedy=reply --re <id> or receipt --note <id>; close --before <cutoff> to bulk-close
...
INBOX OPEN carrying=3 heard=1 large=false remedy=reply --re <id> or receipt --note <id>; close --before <cutoff> to bulk-close
