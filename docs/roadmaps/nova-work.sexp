...
(  :schema "nova-work-roadmap-baseline-1"
  ...
  :future-plans-v2 (    :id "V2"
    ...
    :features (
      ...
      (        :id "V2-F05"
        ...
        :items (
          (            :id "V2-F05-01"
            :title "Personal, group, and shared coordinator notes with authorship, applicability, and routing constraints filtering candidate routes before dispatch"
            :status "proposed"
            :owner "rowan"
            :next-gate "goal-contract"
            :source "issue-321-c5672006742")
          (            :id "V2-F05-02"
            :title "Set, retrieve, and update operations for shared current goal across models and harnesses with revision-aware conflict handling, ownership, and evidence preservation"
            :status "proposed"
            :owner "rowan"
            :next-gate "goal-contract"
            :source "issue-321-c5672006742")))))
  ...
  :rd-work (
    (      :id "RD-01"
      :title "PR #300: nova-work slice 1: C/O transition kernel with write-maintained \|O\|"
      :status "merged"
      :owner "rowan"
      :next-gate "integrated"
      :source "pr-300")
    (      :id "RD-02"
      :title "PR #310: migrate PR #264 profiles to 8-member config preimage, execution, and control schemas"
      :status "merged"
      :owner "gafferongames"
      :next-gate "parent-gate"
      :source "pr-310")
    (      :id "RD-03"
      :title "PR #311: worker cards, the practices with their evidence"
      :status "merged"
      :owner "rowan"
      :next-gate "integrated"
      :source "pr-311")
    (      :id "RD-04"
      :title "PR #312: reply transaction drafted without hand-built header (read half)"
      :status "merged"
      :owner "rowan"
      :next-gate "integrated"
      :source "pr-312")
    (      :id "RD-05"
      :title "PR #314: no-effect events, --dry-run, container count consolidated spec"
      :status "merged"
      :owner "rowan"
      :next-gate "integrated"
      :source "pr-314")
    (      :id "RD-06"
      ...
      :source "pr-316")
    (      :id "RD-07"
      :title "PR #317: enforceable efficiency policy, cache-aware costs and batching spec"
      :status "merged"
      :owner "gafferongames"
      :next-gate "implementation-gate"
      :source "pr-317")
    (      :id "RD-08"
      :title "PR #319: recursive project and tool-stream grouping spec"
      :status "merged"
      :owner "gafferongames"
      :next-gate "implementation-gate"
      :source "pr-319")
    (      :id "RD-09"
      :title "PR #320: refuse forbidden reader tokens before interning"
      :status "merged"
      :owner "gafferongames"
      :next-gate "full-verification"
      :source "pr-320")
    (      :id "RD-10"
      :title "PR #322: cascade static required-member containers"
      :status "merged"
      :owner "gafferongames"
    ...
    (      :id "RD-11"
      ...
      :source "pr-323")
    (      :id "RD-12"
      :title "PR #325: reconcile swarm migration status and re-reservation hashes"
      :status "merged"
      :owner "gafferongames"
    ...
    (      :id "RD-13"
      ...
      :source "pr-326")
    (      :id "RD-14"
      :title "PR #330: refresh roadmap with merged slices and current review gates"
      :status "merged"
      :owner "gafferongames"
    ...
    (      :id "RD-17"
      ...
      :source "pr-333")
    (      :id "RD-18"
      :title "PR #334: refresh now register with merged slices and active review gates"
      :status "merged"
      :owner "gafferongames"
      :next-gate "superseded"
      :source "pr-334")
    (      :id "RD-19"
      :title "PRs #293-#295: nova-work structure, assignment, and history contracts"
      :status "in-review"
      :owner "rowan"
