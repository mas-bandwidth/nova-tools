...
(  :schema "nova-work-roadmap-baseline-1"
  ...
  :future-plans-v2 (    :id "V2"
    ...
    :features (
      ...
      (        :id "V2-F05"
        ...
        :items (
          (            :id "V2-F05-01"
            :title "Durable cross-model coordinator notes stream with sender attribution, monotonic sequence numbers, and bounded retention"
            :status "proposed"
            :owner "stella"
            :next-gate "v2-spec"
            :source "pr-335")
          (            :id "V2-F05-02"
            :title "Atomic shared current-goal register across heterogeneous agents with optimistic concurrency and conflict detection"
            :status "proposed"
            :owner "stella"
            :next-gate "v2-spec"
            :source "pr-335")))))
  ...
  :rd-snapshot-at "2026-09-14T23:50:00Z"
  :rd-source-main "36efe4a9d62dfd1ae7500817fa2a19163e879de4"
  :rd-source-spec "9c120a3b0c1b01475e13cb7bd36014ada2dfa729"
  :rd-work (
    (      :id "RD-01"
      :title "PR #300: Common Lisp C/O kernel and maintained open counter"
      :status "in-review"
      :owner "rowan"
      :next-gate "merge-gate"
      :source "pr-300")
    (      :id "RD-02"
      :title "PR #310: Token ledger preimage migration integration into PR #264"
      :status "in-review"
      :owner "rowan"
      :next-gate "parent-gate"
      :source "pr-310")
    (      :id "RD-03"
      :title "PR #311: Common Lisp test suite parity with SBCL"
      :status "in-review"
      :owner "freddy"
      :next-gate "merge-gate"
      :source "pr-311")
    (      :id "RD-04"
      :title "PR #312: SBCL memory compaction and foreign memory hardening"
      :status "in-review"
      :owner "freddy"
      :next-gate "merge-gate"
      :source "pr-312")
    (      :id "RD-05"
      :title "PR #314: Common Lisp compiler warnings pass"
      :status "in-review"
      :owner "freddy"
      :next-gate "merge-gate"
      :source "pr-314")
    (      :id "RD-06"
      :title "PR #316: Common Lisp reader/writer roundtrip in PR #240"
      :status "in-review"
      :owner "freddy"
      :next-gate "parent-gate"
      :source "pr-316")
    (      :id "RD-07"
      :title "PR #317: Efficiency policy acceptance replays in spec/nova-work"
      :status "in-review"
      :owner "freddy"
      :next-gate "merge-gate"
      :source "pr-317")
    (      :id "RD-08"
      :title "PR #319: Recursive project and stream grouping in spec/nova-work"
      :status "in-review"
      :owner "stella"
      :next-gate "merge-gate"
      :source "pr-319")
    (      :id "RD-09"
      :title "PR #320: Restricted reader repairs merged into main"
      :status "in-review"
      :owner "freddy"
      :next-gate "verification"
      :source "pr-320")
    (      :id "RD-10"
      :title "PR #322: Work-set static container cascades and atomic settle/revive"
      :status "in-review"
      :owner "rowan"
      :next-gate "verification"
      :source "pr-322")
    (      :id "RD-11"
      :title "PR #323: Finite records contract decision packet and Rule 29 amendment"
      :status "in-review"
      :owner "emma"
      :next-gate "whole-package-slice"
      :source "pr-323")
    (      :id "RD-12"
      :title "PR #325: Swarm job profile re-reservation and migration status in PR #264"
      :status "in-review"
      :owner "stella"
      :next-gate "runtime-gate"
      :source "pr-325")
    (      :id "RD-13"
      :title "PR #326: Native optional batch receipt proposal"
      :status "in-review"
      :owner "rowan"
      :next-gate "encoding-gate"
      :source "pr-326")
    (      :id "RD-14"
      :title "PR #330: Roadmap refresh with verified evidence through 21:57Z"
      :status "in-review"
      :owner "freddy"
      :next-gate "verification"
      :source "pr-330")
    (      :id "RD-15"
      :title "PR #331: Runtime task start and restart through kernel submit path"
      :status "in-review"
      :owner "rowan"
      :next-gate "freddy-review"
      :source "pr-331")
    (      :id "RD-16"
      :title "PR #332: Batch receipt admission companion specification"
      :status "in-review"
      :owner "stella"
      :next-gate "darwin-witness"
      :source "pr-332")
    (      :id "RD-17"
      :title "PR #333: Bounded durable filesystem journal persistence and replay adapter"
      :status "in-review"
      :owner "emma"
      :next-gate "darwin-sync-witness"
      :source "pr-333")
    (      :id "RD-18"
      :title "PR #334: Swarm lease heartbeat and fencing token protocol"
      :status "in-review"
      :owner "stella"
      :next-gate "review"
      :source "pr-334")
    (      :id "RD-19"
      :title "PRs #293-#295: Token ledger schema v2 foundation with Fable approvals"
      :status "in-review"
      :owner "rowan"
      :next-gate "friend-gates"
      :source "prs-293-295")
    (      :id "RD-20"
      :title "Issue #185: Finite records contract and whole-package validation"
      :status "proposed"
      :owner "emma"
      :next-gate "slice-c-validator"
      :source "issue-185")
    (      :id "RD-21"
      :title "Issue #336: Herdr multi-agent coordinator adapter"
      :status "proposed"
      :owner "johnny"
      :next-gate "proposal"
      :source "issue-336"))
