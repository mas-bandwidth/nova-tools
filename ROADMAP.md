...
Current evidence at 2026-09-14T23:00:18Z, main `ece6453a078c95bab91c6d9a959557b41dda2c44` and spec branch `9c120a3b0c1b01475e13cb7bd36014ada2dfa729`; proposed v2 planning source remains issue #321 updated 2026-09-14T20:47:32Z:
...
- [Issue #321](https://github.com/mas-bandwidth/nova-tools/issues/321) updated 2026-09-14T20:47:32Z: recursive real/virtual/mixed nodes, optional repository/Issues/Discussions/email backing and durable delegated-work mappings with accepted completion returned upstream; proposed v2 discoveries remain outside the v1 denominator; recursive node planning proceeds without operational adapters.
- [PR #323](https://github.com/mas-bandwidth/nova-tools/pull/323) merged reviewed decision packet head 01ac4a956fa920fc60b0df9f1dacb08fc23aa8da into main as ece6453a078c95bab91c6d9a959557b41dda2c44 at 22:03:25 UTC. Root 5671287793, Emma, and Rowan cleared; Freddy's card36 approval at 01ac4a9 resolved his older card35 HOLD. The decision packet and Rule 29 amendment pin 55 test witnesses and multi-source/candidate contracts; existing envelope validators do not implement whole-package closure, which remains a queued validator slice.
...
- [PR #330](https://github.com/mas-bandwidth/nova-tools/pull/330) merged reviewed roadmap refresh head 5a66b1c6ea4bffa3c955299101ce516ab353a190 into main as 3d6395c451bfc7b17645df69840daebbcbc092b7 at 22:03:20 UTC, updating current evidence through 21:57:38Z.
- [PR #331](https://github.com/mas-bandwidth/nova-tools/pull/331) at head a918fa8f4628089bbc3f602aa16233e3adf48b11 implements task start and restart through the kernel submit path (todo -> doing -> done -> reopen -> doing -> done) with repeated container history preserved; 37/37 tests pass. Emma review 5671666727 and Rowan review 5671681270 cleared; Freddy review remains pending. Integration into main remains pending.
- [PR #332](https://github.com/mas-bandwidth/nova-tools/pull/332) at repaired head 9704248156640c3778f38ab80fccac57fbc118ec addresses Rowan's four items on batch admission wire and recovery contracts; Stella review 5671797286 asks two completion edits (remove inaccessible successful-probe claim throughout; outcome publisher generates same outcome-*.tmp names recovery recognizes). Pure specification companion, zero runtime changes.
- [PR #333](https://github.com/mas-bandwidth/nova-tools/pull/333) at head 8b38294e11357e96f751aa9d09adc3aff9d30ad9 delivers nova-work bounded durable filesystem journal persistence and replay adapter (file-journal, 43/43 tests pass). Sequential replay restores kernel state without synthesizing clocks/IDs. Stella review 5671911551 asks four bounded repairs (sequence/uncertain append; capacity refusal before fill; synchronization/creation guarantees; private replay before target publication); DeepSeek review produced five findings before swarm format rejection. Accepted journal ownership without claiming a running worker.
- [Issue #185](https://github.com/mas-bandwidth/nova-tools/issues/185): four job rows are two card33 attempts + card35 + card36; the reader accepted all four, folded into two day/model/repository rows. Source gaps, retry attribution and missing parent usage retain their limits. Card33 triage adoption remains ineligible. No valid matched before/after parent-plus-child token-saving result is claimed; retained artifacts alone do not establish production ingestion coverage.
