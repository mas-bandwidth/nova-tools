...
|---|---|:---:|:---:|:---:|---|
| RD-01 | [PR #300](https://github.com/mas-bandwidth/nova-tools/pull/300): nova-work slice 1: C/O transition kernel with write-maintained \|O\| | `merged` | rowan | integrated | [PR #300](https://github.com/mas-bandwidth/nova-tools/pull/300) at d21d65f0 |
| RD-02 | [PR #310](https://github.com/mas-bandwidth/nova-tools/pull/310): migrate PR #264 profiles to 8-member config preimage, execution, and control schemas | `merged` | gafferongames | parent-gate | [PR #310](https://github.com/mas-bandwidth/nova-tools/pull/310) at 95ceae8b into PR #264 |
| RD-03 | [PR #311](https://github.com/mas-bandwidth/nova-tools/pull/311): worker cards, the practices with their evidence | `merged` | rowan | integrated | [PR #311](https://github.com/mas-bandwidth/nova-tools/pull/311) at 14ef63b1 |
| RD-04 | [PR #312](https://github.com/mas-bandwidth/nova-tools/pull/312): reply transaction drafted without hand-built header (read half) | `merged` | rowan | integrated | [PR #312](https://github.com/mas-bandwidth/nova-tools/pull/312) at 20f8581 |
| RD-05 | [PR #314](https://github.com/mas-bandwidth/nova-tools/pull/314): no-effect events, --dry-run, container count consolidated spec | `merged` | rowan | integrated | [PR #314](https://github.com/mas-bandwidth/nova-tools/pull/314) at 4b99c1b4 |
| RD-06 | [PR #316](https://github.com/mas-bandwidth/nova-tools/pull/316): receipt recovery ordering, attribution selection and claim locking | `merged` | gafferongames | parent-gate | [PR #316](https://github.com/mas-bandwidth/nova-tools/pull/316) at 269e56d2 into PR #240 |
| RD-07 | [PR #317](https://github.com/mas-bandwidth/nova-tools/pull/317): enforceable efficiency policy, cache-aware costs and batching spec | `merged` | gafferongames | implementation-gate | [PR #317](https://github.com/mas-bandwidth/nova-tools/pull/317) at cf5dd8f5 into spec/nova-work |
| RD-08 | [PR #319](https://github.com/mas-bandwidth/nova-tools/pull/319): recursive project and tool-stream grouping spec | `merged` | gafferongames | implementation-gate | [PR #319](https://github.com/mas-bandwidth/nova-tools/pull/319) at 9c120a3b into spec/nova-work |
| RD-09 | [PR #320](https://github.com/mas-bandwidth/nova-tools/pull/320): refuse forbidden reader tokens before interning | `merged` | gafferongames | full-verification | [PR #320](https://github.com/mas-bandwidth/nova-tools/pull/320) at edb9f7f1 into main |
| RD-10 | [PR #322](https://github.com/mas-bandwidth/nova-tools/pull/322): cascade static required-member containers | `merged` | gafferongames | resident-cow-gate | [PR #322](https://github.com/mas-bandwidth/nova-tools/pull/322) at b97e46c1 into main |
| RD-11 | [PR #323](https://github.com/mas-bandwidth/nova-tools/pull/323): finite records contract decision packet and rule 29 amendment | `merged` | gafferongames | validator-slice | [PR #323](https://github.com/mas-bandwidth/nova-tools/pull/323) at ece6453a into main |
| RD-12 | [PR #325](https://github.com/mas-bandwidth/nova-tools/pull/325): reconcile swarm migration status and re-reservation hashes | `merged` | gafferongames | runtime-gate | [PR #325](https://github.com/mas-bandwidth/nova-tools/pull/325) at e750e3a3 into PR #264 |
| RD-13 | [PR #326](https://github.com/mas-bandwidth/nova-tools/pull/326): propose optional native swarm batch admission receipts | `in-review` | rowan | encoding-crash-gates | [PR #326](https://github.com/mas-bandwidth/nova-tools/pull/326) head a8942963 |
| RD-14 | [PR #330](https://github.com/mas-bandwidth/nova-tools/pull/330): refresh roadmap with merged slices and current review gates | `merged` | gafferongames | superseded | [PR #330](https://github.com/mas-bandwidth/nova-tools/pull/330) at 3d6395c4 into main |
| RD-15 | [PR #331](https://github.com/mas-bandwidth/nova-tools/pull/331): start and restart tasks through kernel submit path | `in-review` | rowan | freddy-review | [PR #331](https://github.com/mas-bandwidth/nova-tools/pull/331) head a918fa8f |
| RD-16 | [PR #332](https://github.com/mas-bandwidth/nova-tools/pull/332): batch admission wire and recovery companion specification | `in-review` | emma | friend-gates | [PR #332](https://github.com/mas-bandwidth/nova-tools/pull/332) repaired head 4046a5be; Stella cleared 5672141578 |
| RD-17 | [PR #333](https://github.com/mas-bandwidth/nova-tools/pull/333): bounded durable journal persistence and replay adapter | `in-review` | emma | darwin-sync-witness | [PR #333](https://github.com/mas-bandwidth/nova-tools/pull/333) head 5900acee; Stella accepted delta 5672161233 |
| RD-18 | [PR #334](https://github.com/mas-bandwidth/nova-tools/pull/334): refresh now register with merged slices and active review gates | `merged` | gafferongames | superseded | [PR #334](https://github.com/mas-bandwidth/nova-tools/pull/334) at 36efe4a9 into main |
| RD-19 | [PRs #293-#295](https://github.com/mas-bandwidth/nova-tools/pull/293): nova-work structure, assignment, and history contracts | `in-review` | rowan | schema-gates | [PR #293](https://github.com/mas-bandwidth/nova-tools/pull/293), [PR #294](https://github.com/mas-bandwidth/nova-tools/pull/294), [PR #295](https://github.com/mas-bandwidth/nova-tools/pull/295) (Fable approvals 47c3f9a, 4fddfcb, c2be4d6b) |
| RD-20 | [Issue #185](https://github.com/mas-bandwidth/nova-tools/issues/185): token ledger operational comparison, triage, and accounting | `in-progress` | unassigned | matched-operational-evidence | [Issue #185](https://github.com/mas-bandwidth/nova-tools/issues/185): 4 job rows folded into 2; no matched saving claimed; Slice C validator in PR #338 |
...
| V2-F05-01 | Personal, group, and shared coordinator notes with authorship, applicability, and routing constraints filtering candidate routes before dispatch | E08-F01 | `proposed` | rowan | goal-contract | [Issue #321 (c5672006742)](https://github.com/mas-bandwidth/nova-tools/issues/321#issuecomment-5672006742), [PR #335](https://github.com/mas-bandwidth/nova-tools/pull/335) |
| V2-F05-02 | Set, retrieve, and update operations for shared current goal across models and harnesses with revision-aware conflict handling, ownership, and evidence preservation | E08-F01 | `proposed` | rowan | goal-contract | [Issue #321 (c5672006742)](https://github.com/mas-bandwidth/nova-tools/issues/321#issuecomment-5672006742), [PR #335](https://github.com/mas-bandwidth/nova-tools/pull/335) |
