...
func cmdNative(args []string, stdout, stderr io.Writer) int {
	...
	// fence=rejected path=<p> is the harness's own fence (issue #644) naming where it refused
	// the card; it is present exactly when the fence rejected a path, and never beside OK.
