...
var helpCases = [][]string{
	...
	{"card", "run"}, {"card", "harvest"}, {"card", "launch"}, {"card", "fsck"}, {"card", "ls"},
	...
	{"fleet", "build"}, {"fleet", "build", "set"}, {"fleet", "build", "compile"}, {"fleet", "build", "duty"},
	...
	{"land", "merge"}, {"land", "run"}, {"land", "offer"}, {"land", "list"},
	{"lander"},
