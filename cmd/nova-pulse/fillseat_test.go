...
// (368d348). Studio's share is two and one studio lease is live, so exactly one of two
// cards may run. Before the seat-for-capacity slice the probe asked for swarm-studio,
// missed both facts, and used the formula.
