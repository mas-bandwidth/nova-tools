...
func TestRunOnceIsOneWidthLineAndOneVerdict(t *testing.T) {
	...
	// The card carries its cut stamp: class P (#828) admits only a signed card, and a
	// fixture that skipped the stamp would be testing a launch nobody can run.
	write(t, filepath.Join(queue, "pending", "card-5.md"), pulse.Stamp(
