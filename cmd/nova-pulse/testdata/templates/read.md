...
STEP last. Write RESULT.md with line 1 equal to this card's line 1, line 2 the verdict, then a `not checked: <list>` line naming every axis the read did not cover, then BRANCH <name> and REPO <owner>/<name>.
