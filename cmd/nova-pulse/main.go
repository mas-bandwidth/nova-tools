...
nova-pulse fill    --ready <dir> --launched <dir> --machines <file> [--lanes <file>] [--session <id>] [--bench <name>]... [--local-bench <name>]... [--only <glob>]... [--slots-store <path>] [--slots-owner <name>] [--slots-bin <path>] [--max-load-per-core <f>] [--capacity <n>] [--launcher <path>] [--swarm-root <path>] [--deadline <s>] [--launch-grace <d>] [--interval <d>] [--stop <file>] [--once] [--done <dir>] [--base-sha <sha>] [--keys <file>] [--force]
...
nova-pulse fleet   keeper --queue <dir> [--repo <dir>] [--base <branch>] [--roots <dirs>] [--receipt <file>] [--strict] [--restart]
...
nova-pulse sprint evaluate --store <host:port> --work-set <path.lisp> [--name <id>] [--nova-work <path>] [--base <branch>] [--cache <dir>] [--every <duration> [--rounds <n>]]
