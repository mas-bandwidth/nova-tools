...
nova-pulse cut     --kind read|fix|replay|spec|rebase --repo <o/n> --out <dir> --queue <dir> [--pr <n>] [--head <sha>] [--issue <n>] [--title <t>] [--body-file <f>] [--prior <text>] [--names <a,b>] [--spec-lines <L1-L2>] [--card-kind <kind> --paths <globs> --test "<pkg> <TestName>"] [--legs <a,b>]
