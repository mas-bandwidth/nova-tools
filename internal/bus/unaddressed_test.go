...
// The two shapes off the family's real table, and the two that must NOT be reported.
//
// A note is unaddressed when its whole address resolves to nobody -- not when part of it
// does. "Stella, Team" reaches Stella and is in her inbox, and telling her it went nowhere
...
func TestUnaddressedReason(t *testing.T) {
	...
	want := []string{
		"from-stella/2026-09-07T0001Z-team.md",
		"from-stella/2026-09-07T0002Z-split.md",
		"from-stella/2026-09-07T0003Z-none.md",
	}
	...
	broken := &Note{Path: "from-stella/x.md", Parse: &ParseError{Err: errors.New("not a header line")}}
