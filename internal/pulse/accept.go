...
// nova-pulse certify (T19) writes a record, and rule 5's staling of that record on a
...
// acceptWallMark, acceptFirstLine and acceptToolchainRed live in accept_toolchain.go
// (landed on dev ahead of this gate with the #1806 fix).
