...
func TestHarvestWorkingOffBranchAndBeforeSession(t *testing.T) {
	...
	out, _, _ := wkRun(t, HarvestInput{Working: working, Base: "0123456789ab", Since: "2026-09-15T00:00:00Z", Max: 20, Now: now})
...
func TestHarvestWorkingTimerInstall(t *testing.T) {
	...
	_, _, code := wkRun(t, HarvestInput{Working: working, Root: "x", Base: "0123456789ab", Since: "2026-09-15T00:00:00Z", Timer: "install", Max: 20})
	if code != 0 {
