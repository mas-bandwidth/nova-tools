...
// Registry is the ladder: every mind, in height then name order, the committed
// rules that answer a kind without a call, and the two measured tables beside
// them -- the floor per kind, and the rate per model.
