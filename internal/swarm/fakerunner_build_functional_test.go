...
// The fake runner is BUILT (go build) by TestMain, and only the functional
// tier runs a batch through it: a build and the exec of a built tool are not
// unit tests (Glenn 2026-09-26, nova-tools#4328). The unit tier has no TestMain.
