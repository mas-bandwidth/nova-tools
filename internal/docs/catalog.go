...
var DefaultCatalog = []Entry{
	...
	E("cmd/nova-redis", "bounded Redis spill and recall CLI", "go test ./cmd/nova-redis", "go test ./cmd/nova-redis"),
	...
	E("internal/sprint", "sprint progress, wall, router, and calibration", "go test ./internal/sprint", "go test ./internal/sprint"),
	E("internal/sprintci", "CI pass as a card per PR head", "go test ./internal/sprintci", "go test ./internal/sprintci"),
