...
// writes gh:ref with the issue's state; a pull_request closed entry drops
// the PR's copy; every other entry leaves the copy alone. All in the
// consumer's own pipeline, no GitHub call.
