...
const (
	...
	RuleMappingMissingZeroSemantics = "mapping_missing_zero_semantics"
	RuleMappingRuleShape            = "mapping_rule_shape"
	RuleShardReference              = "shard_reference"
	RuleCoverageReasonSource        = "coverage_reason_source"
)
...
var AllRules = []string{
	...
	RuleMappingMissingZeroSemantics, RuleMappingRuleShape, RuleShardReference,
	RuleCoverageReasonSource,
}
