...
`kernel-components`, `ciworkspace`, `lisptemppath`, `admitkind`, `lispduplicate`, `one section`, `testbins`, `fieldsindex`, `cardtemplates`. Every entry — the ten above too — is written out in
